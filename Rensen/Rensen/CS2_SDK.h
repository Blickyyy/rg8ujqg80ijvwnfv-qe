...
namespace CS2_SDK//开发者工具库(防止和基础函数冲突)
{
	...
	namespace CS2_Offsets//CS2固定偏移量 (游戏更新时需要同时更新 https://github.com/a2x/cs2-dumper.git)
	{
		...
		uintptr_t dwLocalPlayerController = 0x19A66C8;
		uintptr_t dwLocalPlayerPawn = 0x17C37F0;
		uintptr_t dwEntityList = 0x1956A68;
		uintptr_t dwViewAngles = 0x19C7E58;
		uintptr_t dwViewMatrix = 0x19B89F0;
		...
		uintptr_t m_fFlags = 0x63;
		uintptr_t m_iShotsFired = 0x147C;
		uintptr_t m_vecVelocity = 0x3E8;
		uintptr_t m_bSpotted = 0x8;
		uintptr_t m_bIsScoped = 0x22A0; // Beispielwert
		...
		uintptr_t m_dwBoneMatrix = 0x1F0;
		...
		uintptr_t m_iItemDefinitionIndex = 0x129A;
	...
	namespace Advanced//进阶内存扩展函数
	{
		...
		BOOL Move_to_Pos(Variable::Vector3 Target_Pos = { 0,0,0 }, float Edge = 8) noexcept//本地人物移动到指定世界坐标
		{
			...
			if (Edge <= 15 && Target_Distance <= Edge * 2)//降低移动速度
			{
				Sleep(1);//按键缓冲
